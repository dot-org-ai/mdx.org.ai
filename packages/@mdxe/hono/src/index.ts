...
// Content negotiation (mdx-8je.18): Accept / extension → format; the text registers via @mdxui/text
export {
  formatMiddleware,
  formatResponse,
  documentResponse,
...
export {
  ...
  TEXT_REGISTER_MEDIA_TYPES,
  TOKENS_HEADER,
  TOKENS_METHOD_HEADER,
  DEFAULT_TOKENIZER,
  type TextRegister,
  type TextRegisterHeaderOptions,
  type NotAcceptableProblem,
  type Capabilities,
  type TokenCount,
  type TokenizerId,
} from './text.js'
