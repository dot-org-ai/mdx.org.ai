...
**Unstructured Content** is the Markdown body of an MDX document - the human-readable prose that sits between the frontmatter and components. This concern is [MDX](https://mdxjs.com)'s, not ours; MDXLD inherits it unchanged.
