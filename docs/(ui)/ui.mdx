---
title: UI Components
description: Component specifications and rendering packages for MDX applications
root: true
defaultOpen: true
---

The **UI Components** layer provides component specifications and rendering packages for building interfaces from MDX documents.

## mdxui Package

Render MDX to various output formats:

- **@mdxui/html** - HTML strings (SSR)
